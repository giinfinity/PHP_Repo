...
?>
    ...
    <form method="post" action="Kontakt_Ergebnis.php">
        ...
        <!--PHP Version-->
        <input type="checkbox" name="cb5" <?php if (isset($cb) && $cb == "Klimaanlage" )
    echo "checked" ; ?>
        value="Klimaanlage">Klimaanlage<br>
        <input type="checkbox" name="cb6" <?php if (isset($cb) && $cb == "Naviagtor" )
    echo "checked" ; ?>
        value="Navigator">Naviagtor<br>
        <input type="checkbox" name="cb7" <?php if (isset($cb) && $cb == "Standheizung" )
    echo "checked" ; ?>
