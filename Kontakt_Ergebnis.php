...
Autoauswahl: <?php 
if (isset ($_POST["cb1"])) echo "Kleinwagen<br/>";
if (isset ($_POST["cb2"])) echo "Kompaktwagen<br/>";
if (isset ($_POST["cb3"])) echo "Familienwagen<br/>";
if (isset ($_POST["cb4"])) echo "Luxuswagen<br/>"; ?><br>

Autozubehör: <?php 
if (isset ($_POST["cb5"])) echo "Klimaanlage<br/>";
if (isset ($_POST["cb6"])) echo "Heizung<br/>";
if (isset ($_POST["cb7"])) echo "Navigator<br/>"; ?><br>
